    ...
    def train(self, stop_at_convergence=False, **kwargs):
        ...
        for episode in range(1, episodes + 1):
            ...
            while True:
                ...
                # similar to q-learning, add learnt state into dynaQ dictionary
                dqModel[(state,action)] = (next_state, reward, dqStatus)

                # implement Dyna-Q planning to simulate random experience
                for _ in range(n_planning):

                    # get random node from dictionary for simulation
